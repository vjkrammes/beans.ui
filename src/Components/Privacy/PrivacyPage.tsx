...
export default function PrivacyPage() {
  return (
    <div className="container">
      <PageHeader heading="Privacy" showHomeButton={true} />
      <div className="content">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to VJK Solutions, LLC, 9200 NW 39th Ave,
              Suite 130-3218, Gainesville, FL, 32606-3083.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Beans, accessible from{' '}
              <a
                href="https://beans.azurewebsites.net"
                rel="external nofollow noopener noreferrer"
                target="_blank"
              >
                https://beans.azurewebsites.net
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>
              By email:{' '}
              <span style={{ fontWeight: '700' }}>admin@vjk.solutions</span>
            </p>
          </li>
          <li>
            <p>
